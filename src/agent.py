...
class RoteiristaAgent:
    ...
    def analisar_calibracao(self, original, final, categories_list=[], codigo_original=""):
        ...
        sys_prompt = (
            ...
            "   - CERTO: '- Focar no benefício emocional em vez da ficha técnica (Ex: Trocou \"Possui painel IPS\" por \"Cores vivas de qualquer ângulo com o painel IPS\"). - Iniciar o texto com sujeito explícito (Ex: \"Ela tem\" em vez de \"Tem\").'\n"
