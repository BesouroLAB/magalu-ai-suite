...
class RoteiristaAgent:
    ...
    def analisar_calibracao(self, original, final, categories_list=[], codigo_original=""):
        ...
        sys_prompt = (
            ...
            "   - REGRA DE CONTEXTO: Se o humano CORTOU ou ADICIONOU um bloco inteiro de texto, explique O QUE era e POR QUE (Ex: 'Cortou frase técnica secundária sobre cansaço visual para focar apenas nas conexões e manter ritmo rápido').\n"
